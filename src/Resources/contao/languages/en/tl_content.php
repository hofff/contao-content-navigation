 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_content']['hofff_toc_source']            = ['Section', 'Select the section for which you want to create the content navigation.'];
$GLOBALS['TL_LANG']['tl_content']['hofff_toc_min_level']         = ['Start level', 'Start at this headline level (inclusive).'];
